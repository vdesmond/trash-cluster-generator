...
*Points*: The number of control points (Used to determine the nature of the Bezier Curve) to use. The minimum number of points is 3. The more points you use, the more feature rich the shapes can become; at the risk of creating overlaps or loops in the curve.
